...
public class DeviceUniqueUtil {
	...
	/**
	 * Android UUID method. It could be an unique solution. See. http://developer.android.com/reference/java/util/UUID.html
	 */
	@Nullable
	private static String getAndroidUUID( Context _c ) {
